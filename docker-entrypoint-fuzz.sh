...
export JAM_FUZZ_STATE_STATS_INTERVAL="${JAM_FUZZ_STATE_STATS_INTERVAL:-100000}"
export JAM_FUZZ_SMAPS_TOP="${JAM_FUZZ_SMAPS_TOP:-0}"
export JAM_FUZZ_GC_PROBE="${JAM_FUZZ_GC_PROBE:-0}"
export JAM_FUZZ_MALLOC_TRIM_INTERVAL="${JAM_FUZZ_MALLOC_TRIM_INTERVAL:-0}"
export JAM_FUZZ_TRACEMALLOC="${JAM_FUZZ_TRACEMALLOC:-0}"
export JAM_FUZZ_TRACEMALLOC_TOP="${JAM_FUZZ_TRACEMALLOC_TOP:-0}"
export JAM_FUZZ_OBJECT_CENSUS_TOP="${JAM_FUZZ_OBJECT_CENSUS_TOP:-0}"
