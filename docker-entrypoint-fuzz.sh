...
export JAM_FUZZ_SMAPS_TOP="${JAM_FUZZ_SMAPS_TOP:-10}"
export JAM_FUZZ_GC_PROBE="${JAM_FUZZ_GC_PROBE:-1}"
export JAM_FUZZ_MALLOC_TRIM_INTERVAL="${JAM_FUZZ_MALLOC_TRIM_INTERVAL:-1000}"
export JAM_FUZZ_TRACEMALLOC="${JAM_FUZZ_TRACEMALLOC:-1}"
export JAM_FUZZ_TRACEMALLOC_TOP="${JAM_FUZZ_TRACEMALLOC_TOP:-10}"
export JAM_FUZZ_OBJECT_CENSUS_TOP="${JAM_FUZZ_OBJECT_CENSUS_TOP:-20}"
