...
class DisputesErrorCode(Enum):
    ...
    VERDICTS_NOT_SORTED_UNIQUE = (
        "verdicts_not_sorted_unique"  # Verdicts not sorted in ascending order
    )
    ...
    JUDGEMENTS_NOT_SORTED_UNIQUE = (
        "judgements_not_sorted_unique"  # Judgements not sorted in ascending order
    )
    ...
    TOO_MANY_VERDICTS = "too_many_verdicts"
    TOO_MANY_CULPRITS = "too_many_culprits"
    TOO_MANY_FAULTS = "too_many_faults"
