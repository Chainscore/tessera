...
class PedersenVRF(VRF):
    ...
    BBx:Final[int] = 14576224270591906826192118712803723445031237947873156025406837473427562701854
    BBy: Final[int]= 38436873314098705092845609371301773715650206984323659492499960072785679638442
    BB_compressed:Final[int] = 0xaa5f60f3b3126fa406972d2023ee03bf281022209d13882199113619d57ffa54
    ...
    def prove(self,alpha:bytes, secret_key: int,  additional_data:bytes, blinding_factor:int, salt: bytes = b'')->Tuple[BandersnatchPoint,Tuple[BandersnatchPoint,BandersnatchPoint,BandersnatchPoint, int, int]]:
        """
        ...
        Ok = input_point*k
        c = self.challenge(
            [public_key_cp, input_point, output_point, R, Ok],
            additional_data
        )
    ...
    def verify(self,input_point: BandersnatchPoint,additional_data: bytes,output_point: BandersnatchPoint,proof: Tuple[BandersnatchPoint,BandersnatchPoint,BandersnatchPoint,int, int]) -> bool:
        """
