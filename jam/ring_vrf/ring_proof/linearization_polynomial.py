...
from jam.ring_vrf.ring_proof. polynomial_vect_ops import poly_add,poly_subtract,poly_multiply,poly_scalar,poly_evaluate
...
print("prover_end_cmt:",l_agg_cmt)
...
# res=44920803151022524355293335048980144801879910321560440534834966064612116887943