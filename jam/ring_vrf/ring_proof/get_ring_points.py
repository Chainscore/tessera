...
secret_t=5763201215905959162196757845174861855612849471748236070748880108968682793542
...
def main():
    ...
    for i in range(len(pk_x_y_list),Max_ring_size):
        pk_x_y_list.append(twisted_edward_to_sw(PaddingPoint))
