...
class InstructionsWArgs3Reg(InstructionTable):
    ...
    def table(cls) -> Dict[int, OpCode]:
        return {
            190: OpCode(name="add_32", fn=cls.add_32, gas=Gas(0), is_terminating=False),
            191: OpCode(name="sub_32", fn=cls.sub_32, gas=Gas(0), is_terminating=False),
            192: OpCode(name="mul_32", fn=cls.mul_32, gas=Gas(0), is_terminating=False),
            193: OpCode(name="div_u_32", fn=cls.div_u_32, gas=Gas(0), is_terminating=False),
            194: OpCode(name="div_s_32", fn=cls.div_s_32, gas=Gas(0), is_terminating=False),
            195: OpCode(name="rem_u_32", fn=cls.rem_u_32, gas=Gas(0), is_terminating=False),
            196: OpCode(name="rem_s_32", fn=cls.rem_s_32, gas=Gas(0), is_terminating=False),
            197: OpCode(name="shlo_l_32", fn=cls.shlo_l_32, gas=Gas(0), is_terminating=False),
            198: OpCode(name="shlo_r_32", fn=cls.shlo_r_32, gas=Gas(0), is_terminating=False),
            199: OpCode(name="shar_r_32", fn=cls.shar_r_32, gas=Gas(0), is_terminating=False),
            200: OpCode(name="add_64", fn=cls.add_64, gas=Gas(0), is_terminating=False),
            201: OpCode(name="sub_64", fn=cls.sub_64, gas=Gas(0), is_terminating=False),
            202: OpCode(name="mul_64", fn=cls.mul_64, gas=Gas(0), is_terminating=False),
            203: OpCode(name="div_u_64", fn=cls.div_u_64, gas=Gas(0), is_terminating=False),
            204: OpCode(name="div_s_64", fn=cls.div_s_64, gas=Gas(0), is_terminating=False),
            205: OpCode(name="rem_u_64", fn=cls.rem_u_64, gas=Gas(0), is_terminating=False),
            206: OpCode(name="rem_s_64", fn=cls.rem_s_64, gas=Gas(0), is_terminating=False),
            ...
            216: OpCode(name="set_lt_u", fn=cls.set_lt_u, gas=Gas(0), is_terminating=False),
            217: OpCode(name="set_lt_s", fn=cls.set_lt_s, gas=Gas(0), is_terminating=False),
            218: OpCode(name="cmov_iz", fn=cls.cmov_iz, gas=Gas(0), is_terminating=False),
            219: OpCode(name="cmov_nz", fn=cls.cmov_nz, gas=Gas(0), is_terminating=False),
            220: OpCode(name="rot_l_64", fn=cls.rot_l_64, gas=Gas(0), is_terminating=False),
            ...
            230: OpCode(name="min_u", fn=cls._min_u, gas=Gas(0), is_terminating=False),
        }
