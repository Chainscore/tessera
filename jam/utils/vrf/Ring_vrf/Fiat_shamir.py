...
def construct_the_aggregated_polynomial(chunks,c1x,c2x,c3x,c4x,c5x,c6x,c7x):
    ...
    cx=c1x*chunks[0]+c2x*chunks[1]+c3x*chunks[2]+c4x*chunks[3]+c5x*chunks[4]+c6x*chunks[5]+c7x*chunks[6]
    return cx

def construct_the_agg_x(chunks,px,py,sx,bx,accipx,accxx,accyx,qx):
    agg_x=px*chunks[0]+py*chunks[1]+sx*chunks[2]+bx*chunks[3]+accipx*chunks[4]+accxx*chunks[5]+accyx*chunks[6]+qx*chunks[7]
    return agg_x
