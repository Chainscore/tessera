...
#         current_offset += self.public_key.encode_into(buffer, current_offset)
#         current_offset += self.operator_address.encode_into(buffer, current_offset)
#         current_offset += self.data_hash.encode_into(buffer, current_offset)
#         return current_offset - offset

#     def decode_from(self, buffer: Union[bytes, bytearray, memoryview], offset: int = 0) -> Tuple['ValidatorMetadata', int]:
#         current_offset = offset
#         public_key, size = self.public_key.decode_from(buffer, current_offset)
#         current_offset += size
#         operator_address, size = self.operator_address.decode_from(buffer, current_offset)
#         current_offset += size
#         data_hash, size = self.data_hash.decode_from(buffer, current_offset)
#         current_offset += size
