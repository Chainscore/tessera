...
#         if data is None:
#             return PartialState(delta=Delta({}), next_val_key=ValidatorArray([]), phi=Phi([]),
...
#                 partial_state=PartialState(delta=0, next_val_key=0, phi=0, chi=0),  # Check if this needs arguments
#                 i_index=ServiceId(0),
...
#                 test_xcontent.U) if test_xcontent.U is not None else PartialState.default(),
