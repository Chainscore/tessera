...
from jam.types import WorkReport, WorkPackage, Authorizer, RefineContext, ImportSpec, ExtrinsicSpec, WorkItem, \
    ...
    WorkPackageHash, ErasureRoot, ExportsRoot, Ed25519Signature, BandersnatchVrfSignature, ValidatorIndex
...
from jam.network.protocols.ce_144 import AuditAnnouncement, CE144Data, Announcement, Assign, Transmit, \
...
transmit = Transmit(
    header_hash= HeaderHash(b'\x89\xd37\xe0\xe7\xba\x94\xe4\x9d\xbd\xc7\xd1#\xa7\x80,\xb0\x1a\xcb\x15H\xe7\x02\x0b2_\x93\x96\xc8\x114z'),
    tranches=Bytes(U8(0)),
    announcement= Announcement(
        ...
        ed25519_signature=Ed25519Signature(b'\x89\x11\x7f!\x1dsc\x08\xb5\xd9\xc0\xf6\xbd\x0c\xe4\xc5\x01\xaaV\x90u\x05m\r\x00\x14{\xcbAH\xbb\xd0\xfb\xfa\xfc\xb85!\xa3\xdc\xd8z\xfd6E\xeff\x8e\xe2\xb2\xe8\xe0\xac\x0b\rK\xd2\xdbwO\x8aD\xfb\x17x\t\xbd9\xa4\x88\xa6\x88:d\x97\x11\x8eU\x98cD\xe6\x97s\n\x8dH\x16\x9f\x83\xd7jY\xd9F\x00'),
    )
)

evidence = FirstTrancheEvidence(bandersnatch_signature= BandersnatchVrfSignature(b'\x89\x11\x7f!\x1dsc\x08\xb5\xd9\xc0\xf6\xbd\x0c\xe4\xc5\x01\xaaV\x90u\x05m\r\x00\x14{\xcbAH\xbb\xd0\xfb\xfa\xfc\xb85!\xa3\xdc\xd8z\xfd6E\xeff\x8e\xe2\xb2\xe8\xe0\xac\x0b\rK\xd2\xdbwO\x8aD\xfb\x17x\t\xbd9\xa4\x88\xa6\x88:d\x97\x11\x8eU\x98cD\xe6\x97s\n\x8dH\x16\x9f\x83\xd7jY\xd9F\x00'))

data144 = CE144Data(len_a=U32(len(transmit.encode())), tranche_announcement=transmit, len_b=U32(len(evidence.encode())), evidence=evidence)

"""" ==============================================================================++++++++ """

judgment = Judgment(epoch_index=U32(0), validator_index=ValidatorIndex(0), validity=U8(1), work_report_hash=WorkReportHash(wr_hash), ed25519_signature=Ed25519Signature(b'\x89\x11\x7f!\x1dsc\x08\xb5\xd9\xc0\xf6\xbd\x0c\xe4\xc5\x01\xaaV\x90u\x05m\r\x00\x14{\xcbAH\xbb\xd0\xfb\xfa\xfc\xb85!\xa3\xdc\xd8z\xfd6E\xeff\x8e\xe2\xb2\xe8\xe0\xac\x0b\rK\xd2\xdbwO\x8aD\xfb\x17x\t\xbd9\xa4\x88\xa6\x88:d\x97\x11\x8eU\x98cD\xe6\x97s\n\x8dH\x16\x9f\x83\xd7jY\xd9F\x00'))
