...
vector = {
    ...
    Bytes[32].fromhex("3dbc5f775f6156957139100c343bb5ae6589af7398db694ab6c60630a9ed0fcd"): Bytes(
...
def test_node_boundaries():
    ...
    boundaries = trie.get_boundaries(
        Bytes.fromhex("d44438ec54b3f4d9771a43ed435f21b53a4f1f42be4c34b5d998bb9d53adc517")[:31]
    )
