...
vector = {
    ...
    Bytes[32].fromhex(
        "ef11722d05e21b20e7a37e355c685df020a4dcf22fb888f10b0138c7cd162461"
    ): Bytes(create_dummy_bytes(10)),
    Bytes[32].fromhex(
...
def test_node_not_found():
    ...
    boundaries = trie.get_boundaries(
        Bytes.fromhex(
            "d44438ec54b3f4d9771a43ed435f21b53a4f1f42be4c34b5d998bb9d53adc516"
        )[:31]
    )
    assert len(boundaries) == 10
