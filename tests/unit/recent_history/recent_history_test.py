...
from tests.unit.recent_history.test_recent_history_stf import create_block_from_input
from tests.unit.recent_history.types import Input
...
def test_recent_history_demo():
    ...
    block = create_block_from_input(Input({
