...
from jam.merklization import MMR, MMRFunctions, OptionHash
from jam.types import ByteArray32, Null
from jam.types.protocol.crypto import Hash
from tests.unit.recent_history.transformations import vector_transition
from tests.unit.recent_history.types import Testcase, get_testcases_starting_with
...
def test_mmr():
    ...
    # Test Case 2:
    h2: ByteArray32 = ByteArray32(
        "0x7507515a48439dc58bc318c48a120b656136699f42bfd2bd45473becba53462d"
    )
    ...
    # Test Case 3:
    h3: ByteArray32 = ByteArray32(
        "0x8223d5eaa57ccef85993b7180a593577fd38a65fb41e4bcea2933d8b202905f0"
    )

    val3_1 = OptionHash(
        ByteArray32(
            "0xf986bfeff7411437ca6a23163a96b5582e6739f261e697dc6f3c05a1ada1ed0c"
        )
    )
    val3_2 = OptionHash(
        ByteArray32(
    ...
    val3_3 = OptionHash(
        ByteArray32(
            "0xe17766e385ad36f22ff2357053ab8af6a6335331b90de2aa9c12ec9f397fa414"
        )
    )
    ...
    op3_val4 = OptionHash(
        ByteArray32(
            "0x658b919f734bd39262c10589aa1afc657471d902a6a361c044f78de17d660bc6"
        )
    )
    ...
    # Test Case 4:
    h4: ByteArray32 = ByteArray32(
        "0xa983417440b618f29ed0b7fa65212fce2d363cb2b2c18871a05c4f67217290b0"
    )
