...
class TestMixedDisputesScenarios:
    ...
    def test_mixed_verdicts_and_proofs(self):
        ...
        fault_keys = [3]
        faults = create_sorted_faults(target1, False, fault_keys)  # False vote contradicts good verdict
        ...
        assert_state_counts(initial_counts, new_state,
                          good_delta=1, bad_delta=1, offenders_delta=3)
