...
def test_basic_wp_building():
		...
		wi_pc = bytes([0,0,55,149,23,0,240,51,12,1,40,2,124,201,120,121,149,204,1,149,119,1,82,28,4,246,40,2,51,10,5,51,11,51,12,10,18,86,23,255,6,40,6,51,7,40,2,149,120,4,149,23,0,240,10,19,50,0,145,42,137,82,69,149,40])
		...
		PsiR(0, p=package, auth_trace=auth_trace, i_segments=b"", e_offset=0).execute()